  ...
  return (
    <section id="contact" className="py-24 px-6 border-t border-surface-border">
      <div className="max-w-6xl mx-auto text-center">
        <div className="text-body text-green-brand mb-3">04. contact</div>
        <h2 className="text-heading text-ink mb-4">ติดต่อ</h2>
        <p className="text-body text-ink-muted max-w-md mx-auto mb-10">
          สนใจพูดคุยเกี่ยวกับโปรเจกต์หรือโอกาสทางธุรกิจ ติดต่อได้เลยครับ
        </p>

        <a
          href="mailto:phisit@sleekev.com"
          className="inline-flex items-center gap-2 bg-green-brand text-white text-body px-7 py-2.5 rounded-lg hover:bg-green-700 transition-colors duration-200"
        >
        ...
        <div className="mt-16 pt-8 border-t border-surface-border flex items-center justify-center gap-6">
          <a
            href="https://github.com/sleek-phisit"
            target="_blank"
            rel="noopener noreferrer"
            className="text-ink-faint hover:text-green-brand transition-colors"
            aria-label="GitHub"
          >
