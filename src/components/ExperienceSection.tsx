  ...
  return (
    <section id="experience" className="py-24 px-6 border-t border-surface-border">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          <div className="text-body text-brand mb-3">02. experience</div>
          ...
          <div className="space-y-8">
            {experiences.map((exp) => (
              <div key={exp.company} className="md:pl-10 relative">
                <div className={`absolute left-0 top-2 w-3.5 h-3.5 rounded-full border-2 hidden md:block ${exp.current ? 'bg-brand border-brand' : 'bg-white border-surface-border'}`} />

                <div className="bg-white border border-surface-border rounded-2xl p-6 hover:border-brand/40 transition-colors">
